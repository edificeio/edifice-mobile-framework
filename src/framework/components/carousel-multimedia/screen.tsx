...
// we use a context because the carousel lib is recycling components and it creates duplicates components with the same indexes, so it is impossible to identify a given component only by its index
...
const CarouselScreen = ({
  ...
  return (
    <PageView style={styles.container} showNetworkBar={false} showToast={false}>
      <OrientationLocker orientation={orientation} onDeviceChange={onOrientationChange} />
