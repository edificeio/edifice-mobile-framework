...
export default function PaginatedDocumentList({
  ...
  const getItemType: NonNullable<Readonly<PaginatedListProps<PaginatedDocumentListItemType>>['getItemType']> = React.useCallback(
    (item, index) => {
  ...
  const keyExtractor: NonNullable<Readonly<PaginatedListProps<PaginatedDocumentListItemType>>['keyExtractor']> = React.useCallback(
    (item, index) => {
  ...
  const renderItem: NonNullable<Readonly<PaginatedListProps<PaginatedDocumentListItemType>>['renderItem']> = React.useCallback(
    (
      info:
  ...
  const getVisibleItemIndex: NonNullable<Readonly<PaginatedListProps<PaginatedDocumentListItemType>>['getVisibleItemIndex']> =
    React.useCallback(n => n - totalFolders, [totalFolders]);

  return (
    <PaginatedList<PaginatedDocumentListItemType>
      data={data}
