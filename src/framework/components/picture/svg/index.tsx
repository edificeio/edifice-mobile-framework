...
const imports = {
  ...
  'actualites': async () => import('ASSETS/icons/moduleIcons/newsFeed.svg'),
  'admin': async () => import('ASSETS/icons/moduleIcons/admin.svg'),
  'appointments': async () => import('ASSETS/icons/moduleIcons/appointments.svg'),
  'archive': async () => import('ASSETS/icons/moduleIcons/archives.svg'),
  'assistance': async () => import('ASSETS/icons/moduleIcons/assistance.svg'),
  'assr': async () => import('ASSETS/icons/moduleIcons/assr.svg'),
  'banquesavoir': async () => import('ASSETS/icons/moduleIcons/banquesavoir.svg'),
  'bcdi': async () => import('ASSETS/icons/moduleIcons/bcdi.svg'),
  'biblionisep': async () => import('ASSETS/icons/moduleIcons/biblionisep.svg'),
  'blog': async () => import('ASSETS/icons/moduleIcons/blog.svg'),
  'bureautique': async () => import('ASSETS/icons/moduleIcons/bureautique.svg'),
  'cahier-de-texte': async () => import('ASSETS/icons/moduleIcons/homework1D.svg'),
  'cahier-textes': async () => import('ASSETS/icons/moduleIcons/diary.svg'),
  'calendar': async () => import('ASSETS/icons/moduleIcons/calendar.svg'),
  'ccn': async () => import('ASSETS/icons/moduleIcons/ccn.svg'),
  'cerise': async () => import('ASSETS/icons/moduleIcons/cerise.svg'),
  'cervoprint': async () => import('ASSETS/icons/moduleIcons/cervoprint.svg'),
  'charlemagne': async () => import('ASSETS/icons/moduleIcons/charlemagne.svg'),
  'charte': async () => import('ASSETS/icons/moduleIcons/charte.svg'),
  'cidj': async () => import('ASSETS/icons/moduleIcons/cidj.svg'),
  'cns': async () => import('ASSETS/icons/moduleIcons/cns.svg'),
  'collaborative-wall': async () => import('ASSETS/icons/moduleIcons/collaborativeWall.svg'),
  ...
  'competences': async () => import('ASSETS/icons/moduleIcons/evaluations.svg'),
  'conversation': async () => import('ASSETS/icons/moduleIcons/messages.svg'),
  'course-create': async () => import('ASSETS/images/communities/course-create.svg'),
  'course-link': async () => import('ASSETS/images/communities/course-link.svg'),
  ...
  'educagri': async () => import('ASSETS/icons/moduleIcons/educagri.svg'),
  ...
  'esidoc': async () => import('ASSETS/icons/moduleIcons/esidoc.svg'),
  'europress': async () => import('ASSETS/icons/moduleIcons/europress.svg'),
  'exercices': async () => import('ASSETS/icons/moduleIcons/exercices.svg'),
  'exercizer': async () => import('ASSETS/icons/moduleIcons/exercizer.svg'),
  'explorer': async () => import('ASSETS/icons/moduleIcons/explorer.svg'),
  'form-default': async () => import('ASSETS/images/form-default.svg'),
  'forms': async () => import('ASSETS/icons/moduleIcons/forms.svg'),
  'forum': async () => import('ASSETS/icons/moduleIcons/forum.svg'),
  'geogebra': async () => import('ASSETS/icons/moduleIcons/geogebra.svg'),
  ...
  'le-site-tv': async () => import('ASSETS/icons/moduleIcons/le-site-tv.svg'),
  'lemonde': async () => import('ASSETS/icons/moduleIcons/lemonde.svg'),
  'lesechos': async () => import('ASSETS/icons/moduleIcons/lesechos.svg'),
  'library': async () => import('ASSETS/icons/moduleIcons/library.svg'),
  'livret-scolaire': async () => import('ASSETS/icons/moduleIcons/livretScolaire.svg'),
  'lool': async () => import('ASSETS/icons/moduleIcons/lool.svg'),
  'lsu': async () => import('ASSETS/icons/moduleIcons/lsu.svg'),
  'lvs': async () => import('ASSETS/icons/moduleIcons/lvs.svg'),
  'madmagz': async () => import('ASSETS/icons/moduleIcons/madmagz.svg'),
  'magneto': async () => import('ASSETS/icons/moduleIcons/magneto.svg'),
  'matholycee': async () => import('ASSETS/icons/moduleIcons/matholycee.svg'),
  'maxicours': async () => import('ASSETS/icons/moduleIcons/maxicours.svg'),
  'mediacentre': async () => import('ASSETS/icons/moduleIcons/mediacentre.svg'),
  'mindmap': async () => import('ASSETS/icons/moduleIcons/siteMap.svg'),
  'minetest': async () => import('ASSETS/icons/moduleIcons/minetest.svg'),
  'minibadge': async () => import('ASSETS/icons/moduleIcons/minibadge.svg'),
  'monorientationenligne': async () => import('ASSETS/icons/moduleIcons/monorientationenligne.svg'),
  'monstageenligne': async () => import('ASSETS/icons/moduleIcons/monstageenligne.svg'),
  'moodle': async () => import('ASSETS/icons/moduleIcons/moodle.svg'),
  'multi-account': async () => import('ASSETS/images/multi-account.svg'),
  'museefrancaisphoto': async () => import('ASSETS/icons/moduleIcons/museefrancaisphoto.svg'),
  'nabook': async () => import('ASSETS/icons/moduleIcons/nabook.svg'),
  'netvibes': async () => import('ASSETS/icons/moduleIcons/netvibes.svg'),
  'note': async () => import('ASSETS/icons/moduleIcons/note.svg'),
  'notes': async () => import('ASSETS/icons/moduleIcons/note.svg'),
  'onisep': async () => import('ASSETS/icons/moduleIcons/onisep.svg'),
  'onisep2': async () => import('ASSETS/icons/moduleIcons/onisep2.svg'),
  'pad': async () => import('ASSETS/icons/moduleIcons/pad.svg'),
  'pages': async () => import('ASSETS/icons/moduleIcons/pages.svg'),
  'parametrage': async () => import('ASSETS/icons/moduleIcons/parametrages.svg'),
  'paraschool': async () => import('ASSETS/icons/moduleIcons/paraschool.svg'),
  'pearltrees': async () => import('ASSETS/icons/moduleIcons/pearltrees.svg'),
  'peertube': async () => import('ASSETS/icons/moduleIcons/peertube.svg'),
  'picardie-cursus': async () => import('ASSETS/icons/moduleIcons/picardie-cursus.svg'),
  ...
  'proeps': async () => import('ASSETS/icons/moduleIcons/proeps.svg'),
  'pronote': async () => import('ASSETS/icons/moduleIcons/pronote.svg'),
  'public': async () => import('ASSETS/icons/moduleIcons/public.svg'),
  'qwant-junior': async () => import('ASSETS/icons/moduleIcons/qwant-junior.svg'),
  ...
  'ressourcesdepartementale91': async () => import('ASSETS/icons/moduleIcons/ressourcesdepartementale91.svg'),
  'sacoche': async () => import('ASSETS/icons/moduleIcons/sacoche.svg'),
  'schoolbook': async () => import('ASSETS/icons/moduleIcons/homeLiaisonDiary.svg'),
  ...
  'scolinfo': async () => import('ASSETS/icons/moduleIcons/scolinfo.svg'),
  'scrap-book': async () => import('ASSETS/icons/moduleIcons/scrapbook.svg'),
  'settings-class': async () => import('ASSETS/icons/moduleIcons/settings-class.svg'),
  ...
  'statistics': async () => import('ASSETS/icons/moduleIcons/statistics.svg'),
  'stats': async () => import('ASSETS/icons/moduleIcons/statistics.svg'),
  ...
  'turboself': async () => import('ASSETS/icons/moduleIcons/turboself.svg'),
  ...
  'ui-arrow-important': async () => import('ASSETS/icons/uiIcons/arrow-important.svg'),
  ...
  'ui-calendar-top': async () => import('ASSETS/icons/uiIcons/calendar-top.svg'),
  ...
  'ui-chevron-left': async () => import('ASSETS/icons/uiIcons/chevron-left.svg'),
  'ui-chevron-right': async () => import('ASSETS/icons/uiIcons/chevron-right.svg'),
  ...
  'ui-conversation': async () => import('ASSETS/icons/uiIcons/conversation2.svg'),
  ...
  'ui-inbox-hand': async () => import('ASSETS/icons/uiIcons/inbox-hand.svg'),
  ...
  'ui-link': async () => import('ASSETS/icons/uiIcons/link.svg'),
  ...
  'ui-make-favorite': async () => import('ASSETS/images/myapps/make-favorite.svg'),
  ...
  'ui-navigation-line-ent77': async () => import('ASSETS/icons/uiIcons/navigation-line-ent77.svg'),
  'ui-navigation-line-lyceeconnecte': async () => import('ASSETS/icons/uiIcons/navigation-line-lyceeconnecte.svg'),
  'ui-navigation-line-openent': async () => import('ASSETS/icons/uiIcons/navigation-line-openent.svg'),
  ...
  'ui-notif-empty': async () => import('ASSETS/icons/uiIcons/notif-empty.svg'),
  ...
  'ui-star-outline': async () => import('ASSETS/icons/uiIcons/starOutline.svg'),
  ...
  'ui-topic-other': async () => import('ASSETS/icons/uiIcons/topic-other.svg'),
  ...
  'universalis': async () => import('ASSETS/icons/moduleIcons/universalis.svg'),
  'unstagepourtous': async () => import('ASSETS/icons/moduleIcons/unstagepourtous.svg'),
  ...
  'userbook': async () => import('ASSETS/icons/moduleIcons/adressBook.svg'),
  'userpage-header': async () => import('ASSETS/images/userpage-header.svg'),
  'visioconf': async () => import('ASSETS/icons/moduleIcons/webconf.svg'),
  'votil': async () => import('ASSETS/icons/moduleIcons/votil.svg'),
  'website': async () => import('ASSETS/icons/moduleIcons/website.svg'),
