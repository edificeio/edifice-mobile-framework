...
const imports = {
  'actualites-large': async () => import('ASSETS/icons/moduleIcons/newsFeed.svg'),
  'admin-large': async () => import('ASSETS/icons/moduleIcons/admin.svg'),
  'appointments-large': async () => import('ASSETS/icons/moduleIcons/appointments.svg'),
  'archive-large': async () => import('ASSETS/icons/moduleIcons/archives.svg'),
  'blog-large': async () => import('ASSETS/icons/moduleIcons/blog.svg'),
  'bureautique': async () => import('ASSETS/icons/moduleIcons/bureautique.svg'),
  'cahier-de-texte-large': async () => import('ASSETS/icons/moduleIcons/homework1D.svg'),
  'cahier-textes-large': async () => import('ASSETS/icons/moduleIcons/diary.svg'),
  'calendar-large': async () => import('ASSETS/icons/moduleIcons/calendar.svg'),
  ...
  'competences-large': async () => import('ASSETS/icons/moduleIcons/evaluations.svg'),
  'conversation-large': async () => import('ASSETS/icons/moduleIcons/messages.svg'),
  ...
  'exercizer-large': async () => import('ASSETS/icons/moduleIcons/exercizer.svg'),
  'form-default': async () => import('ASSETS/images/form-default.svg'),
  'forms': async () => import('ASSETS/icons/moduleIcons/forms.svg'),
  'forum-large': async () => import('ASSETS/icons/moduleIcons/forum.svg'),
  ...
  'Lool-large': async () => import('ASSETS/icons/moduleIcons/lool.svg'),
  'lvs': async () => import('ASSETS/icons/moduleIcons/lvs.svg'),
  'Magneto-large': async () => import('ASSETS/icons/moduleIcons/magneto.svg'),
  'mediacentre-large': async () => import('ASSETS/icons/moduleIcons/mediacentre.svg'),
  'mindmap-large': async () => import('ASSETS/icons/moduleIcons/siteMap.svg'),
  'Minetest-large': async () => import('ASSETS/icons/moduleIcons/minetest.svg'),
  'Minibadge-large': async () => import('ASSETS/icons/moduleIcons/minibadge.svg'),
  'moodle': async () => import('ASSETS/icons/moduleIcons/moodle.svg'),
  'multi-account': async () => import('ASSETS/images/multi-account.svg'),
  'nabook-large': async () => import('ASSETS/icons/moduleIcons/nabook.svg'),
  'pad-large': async () => import('ASSETS/icons/moduleIcons/pad.svg'),
  'pages-large': async () => import('ASSETS/icons/moduleIcons/pages.svg'),
  ...
  'presences-large': async () => import('ASSETS/icons/moduleIcons/presences.svg'),
  'pronote': async () => import('ASSETS/icons/moduleIcons/pronote.svg'),
  'rack-large': async () => import('ASSETS/icons/moduleIcons/rack.svg'),
  'rbs-large': async () => import('ASSETS/icons/moduleIcons/rbs.svg'),
  ...
  'scrap-book-large': async () => import('ASSETS/icons/moduleIcons/scrapbook.svg'),
  'settings-class-large': async () => import('ASSETS/icons/moduleIcons/settings-class.svg'),
  'sharebigfiles-large': async () => import('ASSETS/icons/moduleIcons/shareBigFiles.svg'),
  ...
  'stats-large': async () => import('ASSETS/icons/moduleIcons/stats.svg'),
  'support-large': async () => import('ASSETS/icons/moduleIcons/support.svg'),
  'textbook-default': async () => import('ASSETS/images/textbook-default.svg'),
  'timelinegenerator-large': async () => import('ASSETS/icons/moduleIcons/timeLineGenerator.svg'),
  ...
  'userbook-large': async () => import('ASSETS/icons/moduleIcons/adressBook.svg'),
  ...
  'website-large': async () => import('ASSETS/icons/moduleIcons/website.svg'),
  'wekan': async () => import('ASSETS/icons/moduleIcons/wekan.svg'),
  'wiki-large': async () => import('ASSETS/icons/moduleIcons/wiki.svg'),
  'workspace-large': async () => import('ASSETS/icons/moduleIcons/files.svg'),
};
