...
const imports = {
  ...
  'reaction-awesome': async () => import('ASSETS/icons/reactions/awesome.svg'),
  'reaction-awesome-round': async () => import('ASSETS/icons/reactions/awesome_round.svg'),
  'reaction-instructive': async () => import('ASSETS/icons/reactions/instructive.svg'),
  'reaction-instructive-round': async () => import('ASSETS/icons/reactions/instructive_round.svg'),
  'reaction-thankyou': async () => import('ASSETS/icons/reactions/thankyou.svg'),
  'reaction-thankyou-round': async () => import('ASSETS/icons/reactions/thankyou_round.svg'),
  'reaction-welldone': async () => import('ASSETS/icons/reactions/welldone.svg'),
  'reaction-welldone-round': async () => import('ASSETS/icons/reactions/welldone_round.svg'),
