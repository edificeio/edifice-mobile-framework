...
import { AttachmentsImportScreenNavParams } from '~/framework/components/attachments/import-modal/types';
...
export interface IModalsNavigationParams extends ParamListBase {
  ...
  [ModalsRouteNames.AttachmentsImport]: AttachmentsImportScreenNavParams;
