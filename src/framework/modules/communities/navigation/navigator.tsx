...
import CommunitiesConversationScreen, {
  ConversationScreenOptions as conversationNavBar,
} from '~/framework/modules/communities/screens/conversation';
...
export default () =>
  createModuleNavigator<CommunitiesNavigationParams>(moduleConfig.name, Stack => (
    <>
      ...
      <Stack.Screen
        name={communitiesRouteNames.conversation}
        component={CommunitiesConversationScreen}
        options={conversationNavBar}
        initialParams={{}}
      />
      <Stack.Screen
