...
import { AccountTyoe, IUser } from '~/framework/modules/auth/model';
      ...
      renderItem={({ item, index }) => (
        <View key={item.id}>
          ...
          <HomeworkItem
            ...
            disabled={userType !== AccountTyoe.Student}
...
export default (props: HomeworkListProps) => {
  ...
  return (
    <PageContainer>
      {userType === AccountTyoe.Relative ? <ChildPicker contentContainerStyle={styles.childPickerContentContainer} /> : null}
