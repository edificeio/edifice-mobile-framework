...
export const competencesService = {
  devoirs: {
    get: async (session: ISession, idEtablissement: string, idEleve: string, idPeriode?: string, idMatiere?: string) => {
  ...
  levels: {
    get: async (session: ISession, idStructure: string) => {
  ...
  moyennes: {
    get: async (session: ISession, idEtablissement: string, idEleve: string, idPeriode?: string) => {
