...
export async function getMobileValidationInfos(platformUrl: string) {
  try {
    ...
    // const newy = await sessionFetch.json('/directory/user/mobilestate');
    // console.log('mobileValidationInfos', mobileValidationInfos);
    // console.log('newy', newy);
    // TODO
    // Apparemment problème de compte/session non récupérée via sessionFetch, test = fonctionne avec fetchJSONWithCache, pas avec sessionFetch
...
// IDEM QUE MOBILEVALIDATIONINFOS
