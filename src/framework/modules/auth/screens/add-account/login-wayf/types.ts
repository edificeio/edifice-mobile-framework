...
import { AuthLoginWayfScreenDispatchProps, AuthLoginWayfScreenStoreProps } from '~/framework/modules/auth/templates/login-wayf';

export interface AuthLoginWayfAddAccountScreenProps {}

export interface AuthLoginWayfAddAccountScreenPrivateProps
  extends
    NativeStackScreenProps<AuthNavigationParams, typeof authRouteNames.addAccountLoginWayf>,
