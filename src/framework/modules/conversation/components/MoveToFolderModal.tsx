...
> {
  ...
  public render() {
    ...
    const options: any = [];
    if (!isCurrentFolderInbox) options.push({ label: I18n.get('conversation.inbox'), value: 'inbox' });
      ...
      <ModalBox
        ...
        <ModalContent style={styles.modalContent}>
          <View>
            ...
            {isMoveImpossible ? (
              <SmallBoldText style={styles.text}>{I18n.get('conversation.moveImpossible')}</SmallBoldText>
            ) : (
              <DropDownPicker
                open={openDropdown}
                items={options}
                ...
                placeholder={I18n.get('conversation.moveSelect')}
