...
import { TestTahitiNavigationParams, testTahitiRouteNames } from './navigation';
...
const handleSomeNotificationAction: NotifHandlerThunkAction = notification => async (dispatch, getState) => {
  ...
  // return {
  //   managed: 1,
  //   trackInfo: { action: 'TestTahiti', name: `${notification.type}.${notification['event-type']}` },
  // };
};
