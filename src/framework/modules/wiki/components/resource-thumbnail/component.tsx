...
const ResourceThumbnail: React.FC<ResourceThumbnailProps> = ({ source }) => {
  return <ModuleImage appName={moduleConfig.name} source={source} style={styles.resourceThumbnailContainer} />;
};
