...
import { fetchCourseListFromTeacherAction } from '~/modules/viescolaire/edt/actions/courses';
import { fetchSlotListAction } from '~/modules/viescolaire/edt/actions/slots';
import { getCoursesListState, ICourseListState } from '~/modules/viescolaire/edt/state/courses';
import { getSlotsListState, ISlotListState } from '~/modules/viescolaire/edt/state/slots';
