...
import { coursesService } from '~/modules/viescolaire/dashboard/services/courses';
import { ICourseList, actionTypes } from '~/modules/viescolaire/dashboard/state/courses';
