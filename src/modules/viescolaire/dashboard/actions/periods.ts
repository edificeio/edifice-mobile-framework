...
import { periodsListService } from '~/modules/viescolaire/dashboard/services/periods';
import { IPeriodsList, IYear, periodsActionTypes, yearActionTypes } from '~/modules/viescolaire/dashboard/state/periods';
