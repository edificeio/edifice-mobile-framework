...
import { actionTypesCreateFolder } from '~/modules/workspace/actions/create';
import { actionTypesDelete } from '~/modules/workspace/actions/delete';
import { actionTypesList } from '~/modules/workspace/actions/list';
...
import { IItem, IItems, IState } from '~/modules/workspace/types';
