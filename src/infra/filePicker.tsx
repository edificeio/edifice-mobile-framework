...
export class FilePicker extends React.PureComponent<{
    ...
    render() {
        ...
        },
        {
            ...
            action: () => {
                DocumentPicker.pick({
                    type: DocumentPicker.types.allFiles as Array<PlatformTypes[keyof PlatformTypes][keyof PlatformTypes[keyof PlatformTypes]]> | DocumentType[keyof PlatformTypes],
                    ...options
