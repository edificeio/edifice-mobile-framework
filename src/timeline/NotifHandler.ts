...
const openNotif = {
  '/schoolbook': async (data, latestNews) => {
    ...
    return latestNews.find(n => n.resourceUri === data.resourceUri && n.application === 'schoolbook');
  },
  ...
  '/actualites': async (data, latestNews) => {
    ...
    return latestNews.find(n => n.resourceUri === data.resourceUri && n.application === 'news');
  },
