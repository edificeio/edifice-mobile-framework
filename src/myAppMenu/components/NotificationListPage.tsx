...
import { NewListItem } from "./NewContainerContent";
...
// Render
  ...
  public renderEmptyScreen() {
    return (
      <EmptyScreen
        //TO DO: get real image/title/text
  ...
  public renderNotificationList() {
    ...
    return (
      <FlatList
        ...
        ListFooterComponent={notifications.length === 25 ?
  ...
  public renderNotificationItem(notification: IConversationThread) {
    return (
      // <Swipeable
      ...
      // >
        <NotificationItem
          {...notification}
          onPress={e => this.handleOpenNotification(notification.id)}
        />
      // </Swipeable>
    );
  }
