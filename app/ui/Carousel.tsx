...
export class Carousel extends React.Component<{ images: object[], visible: boolean, startIndex?: number, onClose: () => void }, undefined>{
    carouselRef: any;
    currentScroll = 0;
    previousScroll = 0;
    currentImage = 0;
    ...
    render(){
		const { width, height } = Dimensions.get('window');
		return (
			<Modal visible={ this.props.visible } onRequestClose={ () => this.setState({ fullscreen: false })} transparent={ true }>
