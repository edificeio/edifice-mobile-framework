...
// NOTE : discard fetching in this file. Should be done in diaries, as the backend give all the data for all diaries at a single time.
// NOTE : It could be optimised in the backend to load less data at a time...
