...
import type { {{moduleName | toCamelCase | capitalize}}HomeScreen } from '~/framework/modules/{{moduleName}}/screens/home';
...
export interface {{moduleName | toCamelCase | capitalize}}NavigationParams extends ParamListBase {
  home: {{moduleName | toCamelCase | capitalize}}HomeScreen.NavParams;
}
