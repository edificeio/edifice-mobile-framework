...
//
// import {{moduleName | toCamelCase | capitalize}}{{screenName | toCamelCase | capitalize}}Screen, { computeNavBar as {{screenName | toCamelCase}}NavBar } from '~/framework/modules/{{moduleName}}/screens/{{screenName}}';
//
